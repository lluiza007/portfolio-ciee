...
const Introdução = () => {
    return (
        <div style={{backgroundColor: 'rgb(6, 82, 82)', color: 'white', textAlign: 'center', border: '2px solid black', padding: '0', borderRadius: '10px', margin:'5px 0', height: '550px', width: '50%'}}>
